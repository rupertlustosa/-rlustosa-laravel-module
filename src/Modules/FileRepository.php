...
namespace RLustosa\LaravelModulating\Modules;
...
use RLustosa\LaravelModulating\Collection;
use RLustosa\LaravelModulating\Contracts\RepositoryInterface;
use RLustosa\LaravelModulating\Exceptions\InvalidAssetPath;
use RLustosa\LaravelModulating\Exceptions\ModuleNotFoundException;
use RLustosa\LaravelModulating\Json;
...
abstract class FileRepository implements RepositoryInterface, Countable
{
     ...
     * @param string $args
     * @param string $path
     * @return \RLustosa\LaravelModulating\Module
     */
     ...
     * @return string
     * @throws \RLustosa\LaravelModulating\Exceptions\ModuleNotFoundException
     */
